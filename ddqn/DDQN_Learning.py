...
def sample_memories(replay_memory, batch_size):
    ...
    return (cols[0].reshape(batch_size, state_size), cols[1], cols[2], cols[3].reshape(batch_size, state_size), cols[4])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_update_interval", type=int, default=80)
    parser.add_argument("--save_interval", type=int, default=10000)

    parser.add_argument("--num_epochs", type=int, default=1)
    parser.add_argument("--batch_size", type=int, default=512)
    parser.add_argument("--learning_rate", type=float, default=.003)

    parser.add_argument("--epsilon_max", type=float, default=1.0)
    parser.add_argument("--epsilon_min", type=float, default=.01)
    parser.add_argument("--epsilon_decay_steps", type=float, default=10000)
